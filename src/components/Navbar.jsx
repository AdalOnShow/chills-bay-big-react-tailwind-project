    ...
    return (
        <section className="bg-white dark:bg-black dark:text-white">
            <nav className="container mx-auto z-10">
                        ...
                        <div className="hidden lg:flex space-x-4">
                            ...
                            <div className="relative px-8">
                                ...
                                {isThingsDropdownOpen && (
                                    <div className="absolute right-4 mt-2 rounded-md shadow-lg p-2 bg-white dark:bg-black z-10"
                                        onClick={() => setIsThingsDropdownOpen(!isThingsDropdownOpen)}>
                                        {
                                            [
                                                ...
                                                <a key={index} href={item.href}
                                                    className="block px-3 py-2 hover:bg-[#D6EBFD] dark:hover:bg-primary rounded dropdown-link">
                                                    {item.name}
                                                </a>
                                            ))
                                        }
                            ...
                            <div className="relative px-2">
                                ...
                                {isAccountDropdownOpen && (
                                    <div className="absolute right-4 mt-2  rounded-md shadow-lg p-2 bg-white dark:bg-black"
                ...
                {isMobileNavOpen && (
                    <div
                        className="lg:hidden bg-primary-100 dark:bg-black px-6 py-10 flex flex-col gap-[35px] w-screen absolute top-24 left-0 z-10"
                    >
                        {
                            [
