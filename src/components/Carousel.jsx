...
const Carousel = ({ carouselHeading, carouselTitle, carouselData }) => {
    ...
    return (
        <section className=" dark:bg-black dark:text-white">
            <div className="container mx-auto max-w-[1240px] px-6 xl:px-0 py-14 md:py-16">
                ...
                <h3 className="font-bold text-2xl md:text-[32px] md:ml-[108px] mb-4 max-w-[240px] md:max-w-xl">{carouselTitle}</h3>
                ...
                <div className="relative">
                    ...
                    <div
                        className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:px-[108px]">
                ...
                <div className="hidden lg:flex justify-center gap-4 mt-10">
                    {carouselData.map((_, index) => (
                        <button
                            key={index}
                            className={`size-4 rounded-full ${index === currentIndex ? "bg-primary" : "bg-[#969DAA]"
                                }`}
                            onClick={() => setCurrentIndex(index)}
                        />
                    ))}
