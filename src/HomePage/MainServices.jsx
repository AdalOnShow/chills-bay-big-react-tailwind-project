...
const MainServices = () => {
    ...
    return (
        <section className="container mx-auto max-w-[1240px] pt-[68px] pb-[50px]">
            ...
            <div className="lg:w-[1240x] bg-primary-100 lg:shadow-md px-6 py-14 flex-center flex-col lg:flex-row gap-[56px] lg:gap-[70px] hover:scale-105 transition-all duration-200">
